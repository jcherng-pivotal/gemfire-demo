...
public class CustomerOrder {
	...
	public CustomerOrder(String shippingAddress, long orderDate, Set<String> itemSet) {
		super();
	...
	public String toString() {
		return "CustomerOrder [shippingAddress=" + shippingAddress + ", orderDate=" + orderDate + ", itemSet=" + itemSet
				+ "]";
	}
